class KeyboardExtAx < Formula
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/keyboard-ext-ax --version")
    assert_match '"ok": true', shell_output("#{bin}/keyboard-ext-ax status")
  end
end
